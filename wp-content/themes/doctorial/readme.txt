...
Doctorial WordPress Theme, Copyright 2018 webdevrajan
Doctorial is distributed under the terms of the GNU GPL
...
-> Yes, Of course this theme supports woocommerce and other plugins too.
...
== Changelog ==
= 1.0.17- March 5 2018 =
* reduce size of square image
* bug fixed for sticky header
* added rtl-language-support in theme tags

= 1.0.16- February 19 2018 =
* supports RTL

= 1.0.15 - February 14 2018 =
* fixed slider issues
* screenshot changed
* added german language translation

= 1.0.14 - February 8 2018 =
* fixed issues according to theme reviewers feedback

= 1.0.13 - February 6 2018 =
* fixed issues according to theme reviewers feedback

== Changelog ==
= 1.0.12 - February 6 2018 =
* changes in design
* remove search in header
* replaced Oswald font with Poppins
* screenshot changed
* fixed reviewers feedbacks

= 1.0.11 - December 30 2017 =
* fixed some bugs
* added wpml-config.xml for string translation
* moved homepage sections
* fixed design issues

= 1.0.1 - November 27 2017 =
* fixed issues
* escaping and prefixing
* adding translators comments
